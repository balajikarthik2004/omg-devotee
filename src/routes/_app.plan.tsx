          ...
          <div className="bg-card rounded-xl p-4 lg:p-6">
            ...
            <div className="mt-4 border border-border/50 bg-secondary/20 rounded-lg p-3 relative overflow-hidden">
              ...
              <div className="mt-4 space-y-3 relative z-10 mb-5">
                ...
                <div className="bg-background border border-border/50 rounded-xl p-4 shadow-sm hover:border-saffron/40 transition-colors">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="bg-secondary/50 rounded-lg p-2">
                      <div className="font-semibold mb-0.5 text-foreground">Vande Bharat / Shatabdi</div>
                      <div className="text-muted-foreground">Departs 06:15 AM · Daily</div>
                    </div>
                    <div className="bg-secondary/50 rounded-lg p-2">
                      <div className="font-semibold mb-0.5 text-foreground">Superfast Express</div>
                      <div className="text-muted-foreground">Departs 09:30 AM · Daily</div>
                    </div>
                  </div>
                ...
                <div className="bg-background border border-border/50 rounded-xl p-4 shadow-sm hover:border-saffron/40 transition-colors">
                  <div className="flex justify-between items-start mb-2">
                    <div className="text-sm font-semibold text-foreground flex items-center gap-2"><Bus className="w-4 h-4 text-saffron"/> By Bus (SETC & Private)</div>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    <div className="bg-secondary/50 rounded-lg p-2">
                      <div className="font-semibold mb-0.5 text-foreground">SETC AC Sleeper</div>
                      <div className="text-muted-foreground">Every 1 hour · Govt operated</div>
                    </div>
                    <div className="bg-secondary/50 rounded-lg p-2">
                      <div className="font-semibold mb-0.5 text-foreground">Private Volvo A/C</div>
                      <div className="text-muted-foreground">Night services highly rated</div>
                    </div>
                  </div>
                  <div className="mt-2 text-xs text-muted-foreground flex items-center gap-1.5 border-t border-border/50 pt-2">
                ...
                <div className="bg-background border border-border/50 rounded-xl p-4 shadow-sm hover:border-saffron/40 transition-colors">
                  ...
                  <div className="text-xs text-muted-foreground">Fastest and most flexible. Safe highway conditions. Ola, Uber, and local travel agencies offer outstation drops to {t.city}.</div>
                </div>
              </div>
